...
namespace WebUI.Common
{
    ...
    public static class MailHelper
    {
        ...
        private readonly static string SmtpServer = "smtp.wedn.net";//"smtp.exmail.qq.com";
        private readonly static int SmtpServerPort = 25;
        private readonly static bool SmtpEnableSsl = false;
        private readonly static string SmtpUsername = "t1@wedn.net";// "ims @innofast.net";// ;
        private readonly static string SmtpDisplayName = "传值";
        private readonly static string SmtpPassword = "2014@itcast"; //"hotline2015";//;
